...
#include <errno.h>		/* for definition of errno */	//add by shuaijiang
#include <stdarg.h>		/* ISO C variable aruments */	//add by shuaijiang
...
//add by shuaijiang from lib file error.c
